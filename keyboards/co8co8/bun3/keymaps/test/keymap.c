...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   *  ,-------------------------------
   *  |   A1   B1   C1   D1   E1   F1 61
   *  |   A2   B2   C2   D2   E2   F2 62
   *  |   A3   B3   C3   D3   E3   F3 63
   *  |   A4   B4   C4   D4   E4   F4 64
   *  |   A5   B5   C5   D5   E5   F5 65
   *  `-------------------------------
   *  Slave Side (USB Cable Not Connected Side)
   *  ,-------------------------------
   *  |  SA1  SB1  SC1  SD1  SE1  SF1 s61
   *  |  SA2  SB2  SC2  SD2  SE2  SF2 s62
   *  |  SA3  SB3  SC3  SD3  SE3  SF3 s63
   *  |  SA4  SB4  SC4  SD4  SE4  SF4 s64
   *  |  SA5  SB5  SC5  SD5  SE5  SF5 s65
   *  `-------------------------------
   */

  [_DEFAULT] = LAYOUT( /* Base */ 
		      SEND_A1,  SEND_B1,  SEND_C1,  SEND_D1,  SEND_E1,  SEND_F1,  SEND_61,
		      SEND_A2,  SEND_B2,  SEND_C2,  SEND_D2,  SEND_E2,  SEND_F2,  SEND_62,
		      SEND_A3,  SEND_B3,  SEND_C3,  SEND_D3,  SEND_E3,  SEND_F3,  SEND_63,
		      SEND_A4,  SEND_B4,  SEND_C4,  SEND_D4,  SEND_E4,  SEND_F4,  SEND_64,
		      SEND_A5,  SEND_B5,  SEND_C5,  SEND_D5,  SEND_E5,  SEND_F5,  SEND_65,

		      SEND_SA1, SEND_SB1, SEND_SC1, SEND_SD1, SEND_SE1, SEND_SF1, SEND_S61,
		      SEND_SA2, SEND_SB2, SEND_SC2, SEND_SD2, SEND_SE2, SEND_SF2, SEND_S62,
		      SEND_SA3, SEND_SB3, SEND_SC3, SEND_SD3, SEND_SE3, SEND_SF3, SEND_S63,
		      SEND_SA4, SEND_SB4, SEND_SC4, SEND_SD4, SEND_SE4, SEND_SF4, SEND_S64,
		      SEND_SA5, SEND_SB5, SEND_SC5, SEND_SD5, SEND_SE5, SEND_SF5, SEND_S65
  ),
};
